...
export declare const POOLS_CONFIG_BY_CHAIN: PoolsConfigByChain<ChainId.BSC>;
export declare const LIVE_POOLS_CONFIG_BY_CHAIN: PoolsConfigByChain<ChainId.BSC>;
