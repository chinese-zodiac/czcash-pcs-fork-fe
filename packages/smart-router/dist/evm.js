...
var memoize2__default = /*#__PURE__*/_interopDefault(memoize2);
...
var computeV3PoolAddress = memoize2__default.default(
...
var computeV2PoolAddress = memoize2__default.default(
  sdk.Pair.getAddress,
  (tokenA, tokenB) => `${tokenA.chainId}_${tokenA.address}_${tokenB.address}`
);
var getPoolAddress = memoize2__default.default(
...
var allGuages = gauges.GAUGES_CONFIG[chains.ChainId.BSC];
var getToken = memoize2__default.default(
  (chainId, address) => {
    if (!chainId || !address) {
      return void 0;
    }
...
var getGaugesByChain = memoize2__default.default(
...
var getTokenBasesFromGauges = memoize2__default.default(
  (currency) => {
    ...
    const gauges$1 = getGaugesByChain(currency?.chainId);
...
var getCheckAgainstBaseTokens = memoize2__default.default((currencyA, currencyB) => {
  const chainId = currencyA?.chainId;
...
var getV3PoolMeta = memoize2__default.default(
...
var getV3PoolMetas = memoize2__default.default(
...
var getV3PoolTvl = memoize2__default.default(
  (pools, poolAddress) => {
